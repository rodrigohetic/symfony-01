 ...
 */
final class Version20210324092929 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote CHANGE content content LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote CHANGE content content VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE statistic CHANGE beer_id beer_id INT DEFAULT NULL, CHANGE client_id client_id INT DEFAULT NULL, CHANGE score score INT DEFAULT NULL');
    }
}
